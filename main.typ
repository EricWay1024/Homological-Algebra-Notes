...
On a personal note, I chose to work on these notes primarily because I believed it to be the best way for me to learn. This means, on the one hand, that I have added a lot of details to the otherwise potentially terse and hard-to-understand proofs so that as a learner, I can help myself follow what is going on. On the other, I am bound to make many mistakes and the discussions may lack depths or appear naïve. Therefore, the reader is welcome to submit issues for any advice on GitHub (https://github.com/EricWay1024/Homological-Algebra-Notes), where these notes are open-sourced and updated#footnote[For anyone interested, I write these notes with Typst, a fairly new but much simpler alternative of LaTeX.].
