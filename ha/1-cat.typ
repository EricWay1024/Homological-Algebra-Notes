...
#example[
  ...
  $
    product_(i in I) X_i = {(x_i)_(i in I) | x_i in X_i}
  $ and $product.co_(i in I) X_i$ is the disjoint union.
]
...
#example[
  $"Free"$ is the left adjoint of $"Forget"$. For example, we define the functors between $veck$ and $Set$: $ "Forget": veck &-> Set, \ (V, +, dot) &|-> V; $ $
    "Free" : Set &-> veck, \ X &|-> k[X].
  $
