...
#definition[
  ...
  $
    0 arrow.r R dot e_x arrow.r^x R arrow.r 0
  $ concentrated in degrees $1$ and $0$, where $e_x$ is a symbol to denote the generator of $K_1 lr((x))$, and the differential $R dot e_x ->^x R$ is multiplication by $x$, i.e. $d(e_x) = x$.
]
#definition[
